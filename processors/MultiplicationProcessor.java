...
public class MultiplicationProcessor extends CalculationProcessor{
    public MultiplicationProcessor(CalculationProcessor nextProcessor) {
        super(nextProcessor);
    }
    ...
    public String toString() {
        return "MultiplicationProcessor{" +
